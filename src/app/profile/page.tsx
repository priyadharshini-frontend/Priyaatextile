    ...
    <>
      <style>{`
        ...
        .pp-avatar {
          ...
          box-shadow:
            0 0 0 4px #FFFDF7,
            0 0 0 5px rgba(184,134,11,0.35),
        ...
        .pp-grid .pp-card:nth-child(1) {
          animation-delay: 0.15s;
        }

        .pp-grid .pp-card:nth-child(2) {
          animation-delay: 0.22s;
        }

        .pp-grid .pp-card:nth-child(3) {
          animation-delay: 0.29s;
        }

        .pp-grid .pp-card:nth-child(4) {
